...
complete -c claude-code-hooks -n __fish_use_subcommand -a open -d 'Open a session note in Obsidian'
...
complete -c claude-code-hooks -n '__fish_seen_subcommand_from open' -l list -d 'List recent session notes as JSON'
